...
export const MATERIALES = [
  ...
  },
  {
    ...
    porque: 'El precio de la varilla de acero en RD sigue de cerca el acero internacional y el dólar, y varía por calibre (3/8", 1/2", 5/8"), por grado (40 o 60), por zona y por cantidad. La varilla se vende por quintal (peso) y por unidad (varillas de 20 pies), así que conviene comparar el precio por quintal y por libra antes de comprar.',
